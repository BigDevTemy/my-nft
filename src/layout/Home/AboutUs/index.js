            ...
            <div className="slide-container">
                ...
                <div className="aboutus-Text">
                    ...
                    <p>
                        ...
                        Squirreling Squirrels "SS" is an NFT collection of 2,200 fully hand-drawn squirrels. Two species of squirrels: 500 ice age squirrels and 1,700 current age squirrels; All squirreling on the Ethereum Blockchain. Rarity can be found in 200 plus hand-drawn traits, one of a kind squirrels (characters based from our storyline). Traits can be found in different forms such as robot, gold, diamond, and more. It has been a few years after the last ice age, and the squirrels are currently living in joy and peace in their new homeland. They are fun, active, curious, and sometimes weird; THEY ARE NUT BEYOND NUTS!
                    </p>
                    <p>
