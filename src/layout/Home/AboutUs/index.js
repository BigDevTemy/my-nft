        ...
        <div className="aboutus" id="aboutus">
            ...
            <div className="aboutusContainer">
                <div className="aboutus-Text">
                    {/* {_renderImage()} */}
                    <p>
                        Squirreling Squirrels "SS" is an NFT collection of 6,600 fully hand drawn squirrels. <span>Two species of squirrels:</span> 1,600 ice age squirrels and 5,000 current age Squirrels. Rarity can be found in 200 plus hand drawn traits, one of a kind squirrels (characters base from our storyline), in addition to traits such as robot, gold, diamond and many more; All Squirreling on the Ethereum Blockchain. It has been a few years after the last ice age and the Squirrels are currently living in joy and peace in their new homeland. <span>They are fun, active, curious and sometimes weird;</span> THEY ARE NUT BEYOND NUTS!
                    </p>
                    <p>
