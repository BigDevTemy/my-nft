        ...
        <div className="aboutus" id="aboutus">
            ...
            <div className="aboutusContainer">
                <div className="aboutus-Text">
                    {/* {_renderImage()} */}
                    <p>
                        Squirreling Squirrels "SS" is a 5,555 collection of 100% completely HAND DRAWN SQUIRRELS. <span>Two species of squirrels:</span> 1000 ice age squirrels and 4555 current age Squirrels, the ice age squirrels are scarce and rare. Rarity can be found in 200 plus hand drawn traits, like robot, gold & diamond Squirrels and others; All Squirreling on the Ethereum blockchain. It is been a few years after the last ice age and the Squirrels living in joy and peace in North America. <span>They are fun, active, curious and sometimes weird;</span> THEY ARE NUT BEYOND NUTS!
                    </p>
                    <p>
