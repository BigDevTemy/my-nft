...
const Index = ()=>{
    ...
    const[event,setevent]=useState();
     const handleMouseOver=(x)=>{
         ...
         if(x.contains('event')){
             setpicture(pic4)
             setevent('As part of our commitment to help the global community, we will launch a project of planting 1Million tree. Details will be revealed soon.')
             setsandbox('');
             setssgame('');
             setsoldout('');
         }
         if(x.contains('soldout')){
            ...
            setssgame('');
            setevent('');
            setsoldout('After selling all 5,500NFTs, our journey on Metaverse starts. As an appreciation to SS community we will release many gifts during the sales and after, stay tuned!')
         }
         if(x.contains('sandbox')){
            ...
            setssgame('');
            setevent('');
            setsandbox('Acquire a Land on Sandbox, to build Squirrels Community, where everyone has access to join and have fun. The Land will be fully owned by SS community. Many events will be scheduled like parties, shops, art galleries.')
         }
         if(x.contains('ssgame')){
            ...
            setsandbox('');
            setevent('');
            setssgame(' Build SS 3D-Game on Metaverse. SS holders will use their wallets to join the fun, they have to completed many mission after mission, using maps, keys & other tools. It is fun and earn!')
         }
